    ...
    fetch(
      ...
      .then((data) => {
        ...
        if (latestVersion !== window.__CLOUD_PRICING_API_VERSION__) {
          content = `
          <p class="warning"><img src="/img/warning.svg" class="icon" alt="Warning" /> Cloud Pricing API is using an old version. <a href="https://example.com/cloud-pricing-api-upgrade" target="_blank">Upgrade to v${latestVersion}</a>.</p>
        `;
        }
